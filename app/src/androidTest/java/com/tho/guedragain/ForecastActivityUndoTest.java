...
import com.tho.guedragain.activity.ForecastActivity;
...
public class ForecastActivityUndoTest {
    ...
    public void forecastActivityUndoTest() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.snackbar_action), withText("Deshacer"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.max_temp), withText("Temp. máxima: 25.00 ºC"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Temp. máxima: 25.00 ºC")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.min_temp), withText("Temp. mínima: 10.00 ºC"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class),
                                        1),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("Temp. mínima: 10.00 ºC")));
